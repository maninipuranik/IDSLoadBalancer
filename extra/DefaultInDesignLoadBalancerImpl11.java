	...
	implements InDesignLoadBalancer 
{
	...
	public DefaultInDesignLoadBalancerImpl(ArrayList<InDesignServerInstance> inDesignServerInstanceList) 
	{
		super();
	...
	protected synchronized void assignAppropriateInDesignServer(InDesignRequestResponseInfo inDesignRequestResponseInfo)
	{
		...
		System.out.println("The server " + inDesignRequestResponseInfo.inDesignServerInstance.url + "->" + inDesignRequestResponseInfo.mamFileID);
	...
	protected synchronized void processInDesignServerResponse(InDesignRequestResponseInfo inDesignRequestResponseInfo)
	{
		...
		extraFiles.addAll(inDesignRequestResponseInfo.getOpenFilesFromResponse());
		extraFiles.removeAll(inDesignRequestResponseInfo.inDesignServerInstance.openFileList);
		System.out.println("The server has the open files " + inDesignRequestResponseInfo.inDesignServerInstance.url + "->" + inDesignRequestResponseInfo.getOpenFilesFromResponse().toString());
		System.out.println("The load balancer has the open files " + inDesignRequestResponseInfo.inDesignServerInstance.url + "->" + inDesignRequestResponseInfo.inDesignServerInstance.openFileList.toString());
		if(extraFiles.size()>0) {
			System.out.println("!!!!!!!!!!!!!!!!Preparation of shit Starts!!!!!!!!!!!!!!!!");
			System.out.println("The server has ghost open files " + inDesignRequestResponseInfo.inDesignServerInstance.url + "->" + extraFiles.toString());
